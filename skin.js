...
// Filename: TESTE2.ggsk
// Generated 2025-04-12T17:28:34
...
function pano2vrSkin(player,base) {
	...
	me.callChildLogicBlocksHotspot_ht_node0_changenode = function(){
		if(hotspotTemplates['ht_node']) {
			...
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (hotspotTemplates['ht_node'][i]._chevron_white_lower0 && hotspotTemplates['ht_node'][i]._chevron_white_lower0.logicBlock_visible) {
					hotspotTemplates['ht_node'][i]._chevron_white_lower0.logicBlock_visible();
				}
				if (hotspotTemplates['ht_node'][i]._chevron_black0 && hotspotTemplates['ht_node'][i]._chevron_black0.logicBlock_visible) {
					hotspotTemplates['ht_node'][i]._chevron_black0.logicBlock_visible();
				}
	...
	function SkinHotspotClass_ht_node0(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
...
this.__div.style.top = vs.height / 2 + "px";
	...
	player.addListener('changenode', function(args) { me.callChildLogicBlocksHotspot_ht_node0_active();me.callChildLogicBlocksHotspot_ht_node_active(); });
	player.addListener('changevisitednodes', function(args) { me.callChildLogicBlocksHotspot_ht_node0_changevisitednodes();me.callChildLogicBlocksHotspot_ht_node_changevisitednodes(); });
	...
	player.addListener('varchanged_opt_3d_preview', function(args) { me.callChildLogicBlocksHotspot_ht_node0_varchanged_opt_3d_preview();me.callChildLogicBlocksHotspot_ht_node_varchanged_opt_3d_preview(); });
